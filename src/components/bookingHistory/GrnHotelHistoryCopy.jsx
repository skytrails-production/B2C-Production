                ...
                <div className="row p-0 flightHisOuter">
                  <div className="historyTop">
                    <div>
                      <div className="historyTopLeft">
                        ...
                        <div className="mapp">
                          <a
                            href={`https://www.google.com/maps?q=${item?.hotel?.geolocation?.latitude},${item?.hotel?.geolocation?.longitude}`}
                            target="_blank"
                          >
                            <svg
                              id="fi_2642502"
                      ...
                      <div className="historyStatus">
                        ...
                        <span>
                          {" "}
                          No of People : {"  "} {item?.hotel?.paxes?.length}
                        </span>
                      </div>
                      <div className="historyStatus">
                    ...
                    <div className="historyTopRight">
                      <p>
                        City Code : {"  "} {item?.hotel?.city_code}
                      </p>
                      <span>
                      ...
                      <span>
                        Booking Date : {"  "}{" "}
                        {dayjs(item?.booking_date).format("DD MMM, YY")}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="historyBottom">
                    ...
                    <div className="historyBottomTwo">
                      ...
                      <span>
                        <FaUserFriends /> {"  "} {item?.holder?.name}
                      </span>
                    </div>

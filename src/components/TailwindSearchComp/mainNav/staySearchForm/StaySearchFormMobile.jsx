    ...
    return (
      ...
      >
        {!isActive ? (
            ...
            {selectedFrom ? (
              selectedFrom?.type == "city" ? (
                <span className="block font-medium text-neutral-700 ">
                  ...
                  {selectedFrom?.grnCountryName !== null
                    ? selectedFrom?.grnCountryName
                    : selectedFrom?.tboCountryName}
                  )
                </span>
              ) : (
                <span className="block font-medium text-neutral-700 ">
          ...
          <StayLocationMobile onLocationSelect={handleLocationSelect} />
        )}
      </div>
    );
  };
      ...
      >
        {!isActive ? (
          ...
          >
            ...
            <span>
              {checkinDate
                ? `${dayjs(checkinDate).format("DD, MMM")} - ${dayjs(
                    checkoutDate
                  ).format("DD, MMM")}`
                : "Add date"}
            </span>

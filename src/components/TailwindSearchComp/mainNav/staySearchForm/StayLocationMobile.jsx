...
import { MapPinIcon, MagnifyingGlassIcon, ClockIcon } from "@heroicons/react/24/outline"; // Adjust import based on your icon library setup


const StayLocationMobile = ({
    onLocationSelect,

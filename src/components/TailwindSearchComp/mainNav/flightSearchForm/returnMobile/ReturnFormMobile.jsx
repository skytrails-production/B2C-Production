...
import StayDateRangeMobile from "../../staySearchForm/StayDateRangeMobile";

const ReturnFormMobile = forwardRef((props, ref) => {
    ...
    return (
      ...
      >
        {!isActive ? (
          ...
          <FLightFromMobile onLocationSelect={handleFromSelect} />
        )}
      </div>
    );
  };
    ...
    return (
      ...
      >
        {!isActive ? (
          ...
          <FLightToMobile onLocationSelect={handleToSelect} />
        )}
      </div>
    );
  };
      ...
      >
        {!isActive ? (
          ...
          >
            ...
            <span>
              {departDate
                ? `${dayjs(departDate).format("DD, MMM")} - ${dayjs(
                    arrivalDate
                  ).format("DD, MMM")}`
                : "Add date"}
            </span>
          ...
          <StayDateRangeMobile onDateChange={handleDateChange} />
        )}
      </div>
    );
  };
      ...
      >
        {!isActive ? (
          ...
          >
            ...
            <span>
              {guest?.adults + guest?.children + guest?.infant || "Add guests"}
            </span>
          </button>
        ) : (
...
export default ReturnFormMobile;

...
const FlightBaggageKafila = ({ BaggageMap, isOnward }) => {
        ...
        >
          <div className="flex">
            <div className="w-20 me-4">
              <img
                src={
                  item?.SsrDesc.match(/\d+/)[0] == 3
                    ? Threekg
                    : item?.SsrDesc.match(/\d+/)[0] == 5
                    ? Fivekg
                    : item?.SsrDesc.match(/\d+/)[0] == 10
                    ? Tenkg
                    : item?.SsrDesc.match(/\d+/)[0] == 15
                    ? Fifteenkg
                    : item?.SsrDesc.match(/\d+/)[0] == 20
                    ? Twentykg
                    : item?.SsrDesc.match(/\d+/)[0] == 30
                    ? Thirtykg
                    : Bagg
                }
            ...
            <div className="flex flex-col justify-start items-start">
              <p className="font-medium">{`${item?.SsrDesc}`}</p>
          ...
          {/* <div>
            <p className="text-[10px] font-semibold absolute bottom-0 left-28">
              {item?.SsrDesc}
            </p>
          </div> */}
        </div>
...
export default FlightBaggageKafila;

...
function Items({
    ...
    closeModal, selectedIndex, onFlightSelect
}) {
                    ...
                    <div className="col-lg-9 col-md-9">
                        {filteredData &&
                            filteredData.map((item) => {
                                ...
                                if (
                                    reducerState?.Itenerary?.flightOnewayData?.data?.data?.Response
                                        ?.Error?.ErrorCode === 2 ||
                                    reducerState?.Itenerary?.flightOnewayData?.data?.data?.Response
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div className="singleFlightBoxSeven">
                                                        ...
                                                        <button
                                                            onClick={() => {
                                                                handleFLightSelectForBook(results[0][item]);
                                                            }}
                                                        >
                                                            Select →
                                                        </button>
...
export default function BasicGrid({ closeModal, selectedIndex, onFlightSelect }) {
    const reducerState = useSelector((state) => state);
    const results =

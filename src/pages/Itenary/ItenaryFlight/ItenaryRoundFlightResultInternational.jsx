...
import { quoteAction, resetAllFareData, ruleAction } from '../../../Redux/FlightFareQuoteRule/actionFlightQuote';
                                                                            ...
                                                                            <motion.div variants={variants}
                                                                                ...
                                                                                <div class="returnFlightResultBox">
                                                                                    ...
                                                                                    <div className="returnInternationalViewDetails">
                                                                                        <p>₹ {item?.Fare?.PublishedFare}</p>
                                                                                        {/* <p> {`₹${(Number(item?.Fare?.PublishedFare) + Number(markUpamount) * Number(item?.Fare?.PublishedFare)).toFixed(0)}`}</p> */}

                                                                                        <button
                                                                                            onClick={() => {
                                                                                                // handleIndexId(results[0][item]?.ResultIndex);
                                                                                                handleFLightSelectForBook(item)
                                                                                            }}
                                                                                        >
                                                                                            Select →
                                                                                        </button>

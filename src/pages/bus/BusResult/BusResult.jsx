                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    <div className="singlebusMain">
                                                                        <h3 className="busNameHeading">{busDetails?.TravelName?.toUpperCase()}</h3>
                                                                                                ...
                                                                                                <div>
                                                                                                    <div className="origin">
                                                                                                        ...
                                                                                                        <Select
                                                                                                            ...
                                                                                                            onChange={(value) => {
                                                                                                                setSelectedOrigin(origin.find((item) => item.CityPointIndex === value));
                                                                                                            }}
                                                                                                        >
                                                                                                    ...
                                                                                                    <div className="origin">
                                                                                                        ...
                                                                                                        <Select
                                                                                                            ...
                                                                                                            onChange={(value) => {
                                                                                                                setSelectedDropPoint(destination.find((item) => item.CityPointIndex === value));
                                                                                                            }}
                                                                                                        >

...
const [priceRangeValue, setPriceRangeValue] = useState(maxPrice + 501);
  ...
  const handelClearOne = (item) => {
    let select = selectedCategory.filter((item1) => item1 !== item);setSelectedCategory(select);
  };
  ...
  const handleMouseMove = (e) => {
    ...
    if (
      ...
      Number(priceRangeValue) < maxPrice - 501
    ) {
      ...
      <section className="my-4">
        <div className="container">
          <div className="row">
            ...
            {reducerState?.getBusResult?.isLoading === true || showLoader ? (

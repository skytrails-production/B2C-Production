        ...
        <div className="filterPackageMobileBox">

            {
                !clearVisible ?
                    (
                        ...
                        <div>
                            <p className="d-flex fex-row gap-2 align-items-center" onClick={handleClearFilters}> <span>Clear</span></p>
                        </div>
                    )
            }
            ...
            <div className="selectFilterBoxMobile">
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back" onClick={closeStarModal}>Cancel</Button>,
                        <Button key="submit" type="primary" onClick={handleStarSelection}>Apply Filter</Button>,
                    ]}
                >
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back" onClick={closePriceModal}>Cancel</Button>,
                        <Button key="submit" type="primary" onClick={handlePriceSelection}>Apply Filter</Button>,
                    ]}
                >
                    <div className="holidayFilterSlider">
                        ...
                        <div className="d-flex flex-row justify-content-between align-items-center ">
                            <span style={{ fontWeight: "600", fontSize: "13px" }}>₹ {tempPriceRange?.[0]}</span>
                            <span style={{ fontWeight: "600", fontSize: "13px" }}>₹ {tempPriceRange?.[1]}</span>
                        </div>
                    </div>
                </Modal>
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back" onClick={closeSortModal}>Cancel</Button>,
                        <Button key="submit" type="primary" onClick={handleSortSelection}>Apply Sorting</Button>,
                    ]}
                >
                    <div className="holidayFilterSlider">
                        <p className="">Select Price Range</p>

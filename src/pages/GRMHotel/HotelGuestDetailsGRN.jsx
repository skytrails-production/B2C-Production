            ...
            <>
                <div className="row">
                    ...
                    <div className="col-lg-12 mt-3 mb-2">
                        <div className="roomNameAndCategoryOuter">
                            <h3 className="hotelNameHeading">Room Type : {" "}{hotelinfoGRN?.rate?.rooms?.[0]?.description}</h3>
                            <div className="roomNameAndCategory">

                                <div className="roomTitle">
                                    {/* <h5 className="HotelRoomHeadings1">Room Type : {" "}{hotelinfoGRN?.rate?.rooms?.[0]?.description}</h5> */}

                                    <h5 className="HotelRoomHeadings2">{hotelinfoGRN?.rate?.boarding_details?.[0]}</h5>
                                </div>
                    ...
                    <div className="col-lg-12 mt-3 mb-2">
                        <div className="roomNameAndCategoryOuter">
                            <h3 className="hotelNameHeading">Hotel Location</h3>
                            <div className="roomNameAndCategory">
                                {/* <div className="roomTitle">
                                <h5 className="HotelRoomHeadings2">Hotel Location</h5>
                            </div> */}
                                <div className="w-100">
                                    <iframe
                                        width="100%"
                    ...
                    <form onSubmit={handleClickSavePassenger} className="col-lg-12 mt-3">
                            ...
                            <div className="roomNameAndCategory">
                            ...
                            </div> */}
                                {
                                    hotelinfoGRN?.rate?.rooms?.map((item, roomIndex) => {
                                        return (
                                            <div key={roomIndex}>
                                                <p className="text-bold">Room {roomIndex + 1}</p>
                                                {item?.no_of_adults > 0 &&
                                                ...
                                                {item?.no_of_children > 0 &&
                                                    Array.from({ length: item?.no_of_children }, (_, childIndex) => (
                                                        <div className="bookFlightPassInner" key={childIndex}>
                                                            <div className="bookAdultIndex">
                                                                <p className="text-bold">Child {childIndex + 1}</p>
                                                            </div>
                                                            <div className="row g-3 mb-3">
                                                                <div className="col-lg-3 col-md-3">
                                                                    <label htmlFor="floatingInput">Title</label>

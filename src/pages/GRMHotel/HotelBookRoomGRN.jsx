        ...
        rooms.slice(0, showRooms).map((item, index) => (
            <div className="roomCompo" key={index}>
                <div
                    ...
                    style={{ cursor: "pointer", border: selectedRoomIndex === index ? '0.5px solid #e73c34' : '' }}
                >
                                    ...
                                    item?.boarding_details?.[0] === "Room Only" ? (
                                        <div className="othIncInner">
                                            <div className="d-flex justify-content-start align-items-center gap-2">
                                                ...
                                                <p style={{ fontSize: "13px", fontWeight: "600" }}>Room Only</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="othIncInner">
                                            <div className="d-flex justify-content-start align-items-center gap-2">
                                                ...
                                                <p style={{ fontSize: "13px", fontWeight: "600" }}>Free Breakfast</p>
                                            </div>
                                        </div>
                                    ) : (
                                        <div className="othIncInner">
                                            <div className="d-flex justify-content-start align-items-center gap-2">
                                                ...
                                                <p style={{ fontSize: "13px", fontWeight: "600" }}>{item?.boarding_details?.[0]}</p>
                                            </div>
                                        </div>
                                    )
                                }
                                ...
                                <div className="othIncInner">
                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                        <p className="panDesign3">
                                            Refundable (Cancel Before {dayjs(item?.cancellation_policy?.cancel_by_date).format("DD MMM, YY")})
                                        </p>
                                    </div>
                                </div>
                            )}
                                                    ...
                                                    <Tabs defaultActiveKey="1">
                                                        {roomOnlyAvailable && (
                                                            <TabPane tab="Room Only" key="1">
                                                                {renderRooms(hotelinfoGRN?.rates?.filter((rate) => rate?.boarding_details?.includes("Room Only")))}
                                                            </TabPane>
                                                        )}
                                                        {bedAndBreakfastAvailable && (
                                                            <TabPane tab="Bed and Breakfast" key="2">
                                                                {renderRooms(hotelinfoGRN?.rates?.filter((rate) => rate?.boarding_details?.includes("Bed and Breakfast")))}
                                                            </TabPane>
                                                        )}
                                                        {halfBoardAvailable && (
                                                            <TabPane tab="Half Board" key="4">
                                                                {renderRooms(hotelinfoGRN?.rates?.filter((rate) => rate?.boarding_details?.includes("Half Board")))}
                                                            </TabPane>
                                                        )}
                                                        {fullBoardAvailable && (
                                                            <TabPane tab="Full Board" key="3">
                                                                {renderRooms(hotelinfoGRN?.rates?.filter((rate) => rate?.boarding_details?.includes("Full Board")))}
                                                            </TabPane>
                                                        )}
                                                    </Tabs>
                                                </div>

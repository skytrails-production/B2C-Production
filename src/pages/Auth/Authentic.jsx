...
import { loginAction, loginActionSocial, logoutAction } from "../../Redux/Auth/logIn/actionLogin";
...
const Authentic = ({ isOpen, onClose, isLogoutOpen, onLogoutClose }) => {
    ...
    const isNumberPresent = reducerState?.logIn?.loginData?.data?.result?.phone?.mobile_number;
                    ...
                    <>
                        ...
                        <div className="authenticModalContent">
                            ...
                            </div>
                            {
                                socialLoginOTPVisible ?
                                    (
                                        <Button type="primary" loading={otpLoader} onClick={verifyOTP2} disabled={otp.length < 6}>
                                            Verify OTP
                                        </Button>
                                    ) :
                                    (

                                        <Button type="primary" loading={otpLoader} onClick={addNumberInSocialLogin} disabled={validNumEmail}>
                                            Get OTP
                                        </Button>
                                    )
                            }

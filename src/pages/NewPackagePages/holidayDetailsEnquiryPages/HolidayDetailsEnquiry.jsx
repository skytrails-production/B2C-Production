...
const HolidayDetailsEnquiry = () => {
    ...
    if (loading) {
        return (
            <div><HolidayEnquirySkeleton /> </div>
        )
    }
                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="packCardImg">
                            <Img className="posterImg" src={onePackage?.pakage_img || onePackage?.package_img?.[0]} />
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="HDEright">
                            <div className="HDEtitle">
                            ...
                            <div className="HDEinfo2">
                                ...
                                <div className="HDEinfoItem">
                                    <span className="HDEtext HDEbold">
                                        Price:{" "}
                                    </span>

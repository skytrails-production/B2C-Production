        ...
        <div className='position-relative'>
            <div className="carouselTopCountries">
                ...
                <div className="carouselItems" ref={carouselContainer}>
                    ...
                    <div className="carouselItem" onClick={() => handlecountryClick('India')} >
                    ...
                    <div className="carouselItem" onClick={() => handlecountryClick('Mauritius')} >
                        <div className="posterBlock">
                            <Img src={two} />
                        </div>
                        <div className="textBlock">
                    ...
                    <div className="carouselItem" onClick={() => handlecountryClick('Europe')} >
                        <div className="posterBlock">
                            <Img src={three} />
                        </div>
                        <div className="textBlock">
                    ...
                    <div className="carouselItem" onClick={() => handlecountryClick('Dubai')} >
                        <div className="posterBlock">
                            <Img src={four} />
                        </div>
                        <div className="textBlock">
                    ...
                    <div className="carouselItem" onClick={() => handlecountryClick('France')}>
                        <div className="posterBlock">
                            <Img src={five} />
                        </div>
                        <div className="textBlock">
                    ...
                    <div className="carouselItem" onClick={() => handlecountryClick('Canada')} >
                        <div className="posterBlock">
                            <Img src={six} />
                        </div>
                        <div className="textBlock">

...
const ResultPageSearchLocation = ({
  autoFocus = false,
    ...
    <div className={`relative flex ${className}`} ref={containerRef}>
      ...
      >
        ...
        <div className="flex-grow">
          <input
            className="block w-full bg-transparent border-none focus:ring-0 p-0 focus:outline-none text-xl md:text-2xl lg:text-2xl xl:text-2xl font-bold placeholder-neutral-800 truncate"
...
export default ResultPageSearchLocation;

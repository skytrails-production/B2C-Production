...
const PackageResultFilterMobile = ({
    ...
    const [localSelectedDestinations, setLocalSelectedDestinations] = useState(selectedDestinations);
    ...
    const handleCitiesOk = () => {
        ...
        onFilterChange(localSelectedDestinations, localPriceRange, localSelectedTag, selectedDays); // Apply filter
    ...
    const handlePriceOk = () => {
        ...
        onFilterChange(selectedDestinations, localPriceRange, localSelectedTag, selectedDays); // Apply filter
        ...
        <div className="filterPackageMobileBox">
            ...
            <div className="selectFilterBoxMobile">
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back" onClick={handleCitiesCancel}>Cancel</Button>,
                        <Button key="submit" type="primary" onClick={handleCitiesOk}>Apply Filter</Button>,
                    ]}
                >
                ...
                >
                    <p
                        style={{
                            border: isPriceFilterApplied ? "1px solid #e73c34" : "1px solid gray",
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back" onClick={handlePriceCancel}>Cancel</Button>,
                        <Button key="submit" type="primary" onClick={handlePriceOk}>Apply Filter</Button>,
                    ]}
                >
                ...
                >
                    <p
                        style={{
                            border: isThemesFilterApplied ? "1px solid #e73c34" : "1px solid gray",
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back" onClick={handleThemesCancel}>Cancel</Button>,
                        <Button key="submit" type="primary" onClick={handleThemesOk}>Apply Filter</Button>,
                    ]}
                >
                ...
                <div
                    className="filterCitiesMobile"
                    onClick={showDaysModal}
                >
                    <p
                        style={{
                            border: isDaysFilterApplied ? "1px solid #e73c34" : "1px solid gray",
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back" onClick={handleDaysCancel}>Cancel</Button>,
                        <Button key="submit" type="primary" onClick={handleDaysOk}>Apply Filter</Button>,
                    ]}
                >
                    <div className="PackagetagFilters">
                        <p>Filter By Days</p>

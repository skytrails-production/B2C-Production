...
const ReturnResultInternational = () => {
  ...
  useEffect(() => {
    if (
      ...
      swalModal(
        "flight",
        reducerState?.flightFare?.flightRuleDataReturn?.Error?.ErrorMessage
      );
      navigate("/FlightresultReturn");
    }
  ...
  const handleFLightSelectForBook = (item, i) => {
    ...
    sessionStorage.setItem(
      "selectedFlightGoingInternational",
                  ...
                  <div className="busDepartureMain">
                    <h2 className="sidebar-title">
                      ...
                      {result.length > 0 &&
                        result?.[0][0]?.Segments?.[
                          result?.[0][0]?.Segments?.length - 1
                        ][arrSegmentLength - 1]?.Destination?.Airport?.CityName}
                    </h2>
                                    ...
                                    <div class="returnFlightResultBox">
                                      ...
                                      <div className="returnInternationalViewDetails">
                                        ...
                                        >
                                          ...
                                          <p>
                                            {(item?.Fare?.PublishedFare).toFixed(
                                              0
                                            ) <= 5000
                                              ? (
                                                  item?.Fare?.PublishedFare / 3
                                                ).toFixed(0)
                                              : item?.Fare?.PublishedFare <=
                                                50000
                                              ? (
                                                  item?.Fare?.PublishedFare / 6
                                                ).toFixed(0)
                                              : (
                                                  item?.Fare?.PublishedFare / 12
                                                ).toFixed(0)}
                                            /Month →
                                          </p>
                                        </div>

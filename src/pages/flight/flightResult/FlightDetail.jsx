      ...
      {flight?.Segments?.[0]?.length == 1 ? (
        <div className="flightDetail-box-1">
          <div className="flightDetail-img">
            <img
              src={`https://raw.githubusercontent.com/The-SkyTrails/Images/main/FlightImages/${flight?.Segments?.[0]?.[0]?.Airline?.AirlineCode}.png`}
              alt="flight"
          ...
          <div className="flight-details-right">
            ...
            <div className="flight-details-right-inner flight-details-right-inner-border">
              <div className="flight-details-right-inne-1">
                <span>
                  {formatDateTime(flight?.Segments?.[0]?.[0]?.Origin?.DepTime)}
                </span>
                <p>
                  {flight?.Segments?.[0]?.[0]?.Origin?.Airport?.AirportName} (
        ...
        <>
          {flight?.Segments?.[0]?.map((item, index) => {
            ...
            let isNext = index < flight?.Segments?.[0]?.length - 1;
            let layoverTime;
            if (isNext) {
              ...
              <>
                <div className="flightDetail-box-1">
                  ...
                  <div className="flight-details-right">
                    ...
                    <div className="flight-details-right-inner flight-details-right-inner-border">
                      <div className="flight-details-right-inne-1">
                        <span>{formatDateTime(item?.Origin?.DepTime)}</span>
                        <p>
                      ...
                      <div className="flight-details-right-inne-1">
                        <span>
                          {formatDateTime(item?.Destination?.ArrTime)}
                        </span>
                        <p>

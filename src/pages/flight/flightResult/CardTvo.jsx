...
const CardTvo = ({ flight }) => {
  ...
  let originTime = convertTvoTime(flight?.Segments?.[0]?.[0]?.Origin?.DepTime);
  ...
  return (
    <div className="card-flight">
          ...
          <div className="detail">
            <div className="flight-box-img">
              ...
              <div className="code-name">
                <p style={{ color: "#071C2C" }}>
                  {flight?.Segments?.[0]?.[0]?.Airline?.AirlineName}
                </p>
                <p style={{ color: "#E73C348F" }}>
            ...
            <div className="detail-box-right">
              <div className="flight-box-2">
                <div className="flight-time-1">
                  ...
                  <span>
                    Terminal{" "}
                    {flight?.Segments?.[0]?.[0]?.Origin?.Airport?.Terminal}
                  </span>
                </div>
                <div className="flight-time-2">
                  <p> {`${layoverHours}h ${layoverMinutes}m`}</p>
                  <img src={stopImg} alt="" />
                  <span>
      ...
      {isShow && <FlightDetail flight={flight} />}

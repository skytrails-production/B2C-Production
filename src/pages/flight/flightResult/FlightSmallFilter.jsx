...
const FlightSmallFilter = ({ airlineCodes,
    minPrice,
    maxPrice,
    priceRange,
    onFilter, }) => {
        ...
        <div className="filterPackageMobileBox">
            {
                !clearVisible
                    ...
                    (
                        ...
                        <div>
                            <p className="d-flex fex-row gap-2 align-items-center"
            ...
            <div className="selectFilterBoxMobile">
                ...
                <div
                    className="filterCitiesMobile"
                    onClick={showStopsModal}
                >
                    <p
                        style={{
                            border: isStopsFilterApplied ? "1px solid #e73c34" : "1px solid gray",
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back"
                            onClick={handleStopsCancel}
                        >Cancel</Button>,
                        <Button key="submit" type="primary"
                            onClick={handleStopsOk}
                        >Apply Filter</Button>,
                    ]}
                >
                ...
                <div
                    className="filterCitiesMobile"
                    onClick={showDepTimeModal}
                >
                    <p
                        style={{
                            border: isDepTimeFilterApplied ? "1px solid #e73c34" : "1px solid gray",
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back"
                            onClick={handleDepTimeCancel}
                        >Cancel</Button>,
                        <Button key="submit" type="primary"
                            onClick={handleDepTimeOk}
                        >Apply Filter</Button>,
                    ]}
                >
                ...
                <div
                    className="filterCitiesMobile"
                    onClick={showArrTimeModal}
                >
                    <p
                        style={{
                            border: isArrTimeFilterApplied ? "1px solid #e73c34" : "1px solid gray",
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="back"
                            onClick={handleArrTimeCancel}
                        >Cancel</Button>,
                        <Button key="submit" type="primary"
                            onClick={handleArrTimeOk}
                        >Apply Filter</Button>,
                    ]}
                >
                    <div className="busDepartureMain">

...
const MulticityResult = () => {
    ...
    const result = reducerState?.multicity?.multicityData?.data?.data?.Response?.Results;
    ...
    useEffect(() => {
        ...
        if (reducerState?.multicity?.
            multicityData?.data
            ?.data?.Response?.Error?.
            ErrorCode !== 0 && reducerState?.multicity?.
                multicityData?.data
                ?.data?.Response?.Error?.
                ErrorCode !== undefined

        ) {
            swalModal("flight", reducerState?.multicity?.
                multicityData?.data
                ?.data?.Response?.Error?.
                ErrorMessage, false)
            navigate("/")
    ...
    const handleFLightSelectForBook = (item, i) => {
        ...
        sessionStorage.setItem("selectedFlightmulticity", JSON.stringify(result[0][i]));
                                                                                                        ...
                                                                                                        <>
                                                                                                            ...
                                                                                                            <div class="multicityResultOtherDetails">
                                                                                                                <div class="multicityResultTimingBox">
                                                                                                                    ...
                                                                                                                    <p>{
                                                                                                                        seg?.length > 1 ?
                                                                                                                            `${seg?.length - 1} stop via ${seg?.[0]?.Destination?.Airport?.CityName}` : "Non Stop"}</p>
                                                                                                                </div>

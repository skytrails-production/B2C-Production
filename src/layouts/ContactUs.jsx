    ...
    <div>
      <div style={{ overflow: "hidden" }}>
        <div
          ...
          style={{ marginBottom: "130px", marginTop: "100px" }}
        >
          {loading ? (
            <div
              className="loaderBoxTc"
              style={{
                flex: 1,
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                        ...
                        <div>
                          ...
                          <p>
                            {item?.address[0]?.OperationalAddress.split(
                              ","
                            ).join(" ")}
                          </p>
                          {/* <p>
                            Center 2, Office No 254 6th floor F -Block, Gmada
                            Aerocity, Sahibzada Ajit Singh Nagar, Punjab 140603
                          </p> */}
                        </div>
                      </div>
                    </div>
